...
# ГОРОД: АСТРАХАНЬ
# ИСПРАВЛЕНО: убраны дубликаты, добавлены запятые, исправлены кавычки
# ================================================
...
async def cmd_start(message: types.Message):
    await message.answer(
        ...
        "LG, Yandex, Lenovo, Gefest, ATLANT, САРАТОВ, Philips,\n"
        "Beko, Indesit, Vestel, TCL, Candy, Haier, Leran,\n"
        "Midea, Oasis, Ballu, DON, Hiberg, Willmark, Leff, Centek\n\n"
        "📌 <i>База постоянно пополняется!</i>"
    )
